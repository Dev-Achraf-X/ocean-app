...
function PricingSection() {
  ...
  const tabStyle =
    "basis-1/2 text-center py-2 text-slate-100 capitalize font-semibold tracking-wide rounded-lg cursor-pointer";
  return (
    <section id="pricing" className="flex flex-col gap-8">
      <Heading title="Find a plan to power your projects" isCentered />
      <div className="flex max-w-[12rem] w-full mx-auto p-1 text-base bg-slate-800 rounded-lg">
        <p
